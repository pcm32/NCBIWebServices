 ...
 * @brief   Stores synonyms, preferred names and iupac names for lists of uk.ac.ebi.metabolomes.webservices.pubchem compounds.
 *
 */
public class PubChemNamesResult {
     ...
     * 
     * @return set of uk.ac.ebi.metabolomes.webservices.pubchem compound identifiers
     */
